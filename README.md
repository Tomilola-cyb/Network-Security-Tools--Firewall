...
2. Configuration: Enabled UFW.
   - Set a defaultdeny policy for incoming traffic.
   - Created a specific rule to DENY traffuc on PORT 80 (HTTP).
3. Verification: Used the 'curl' command to attempt a connection to thr blocked port, confirming that the firewall successfully dropped the request.
